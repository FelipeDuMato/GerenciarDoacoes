          ...
          <Card className="mb-4">
            <Card.Body>
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control name="item" onChange={handleChange} type="text" required />
                <Form.Control.Feedback type="invalid">
                  Por favor, insira o item doado.
                </Form.Control.Feedback>
              </Form.Group>
              <Form.Group className="mb-3">
                <Form.Label>Quantidade</Form.Label>
                <Form.Control name="quantidade" onChange={handleChange} type="number" required />
                <Form.Control.Feedback type="invalid">
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control name="descricao" onChange={handleChange} as="textarea" rows={2} required />
                <Form.Control.Feedback type="invalid">
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Select name="destinatario" onChange={handleChange} required>
